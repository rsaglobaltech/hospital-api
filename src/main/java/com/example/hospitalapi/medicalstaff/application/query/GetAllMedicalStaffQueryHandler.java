...
/**
 * Handler for GetAllMedicalStaffQuery
 */
@Service
@RequiredArgsConstructor
public class GetAllMedicalStaffQueryHandler implements QueryHandler<GetAllMedicalStaffQuery, List<MedicalStaffResponse>> {

    private final MedicalStaffRepository medicalStaffRepository;

    /**
     * Handle the GetAllMedicalStaffQuery
     * @param query the query to handle
     * @return list of all medical staff members
     */
    @Transactional(readOnly = true)
    public List<MedicalStaffResponse> handle(GetAllMedicalStaffQuery query) {
        // Find all medical staff
